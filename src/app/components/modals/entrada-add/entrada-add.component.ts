...
@Component({
  selector: 'app-entrada-add',
  standalone: true,
  imports: [FormsModule, CommonModule, DatePickerComponent],
  templateUrl: './entrada-add.component.html',
  styleUrls: ['./entrada-add.component.scss'] // Corrigi o erro de digitação aqui
})
export class EntradaAddComponent {
  @Input() data!: Date;
